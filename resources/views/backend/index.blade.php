...
<head>
    ...
    <link rel="stylesheet" href="assets/backend/css/ready.css">
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        ...
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                aria-expanded="false"> <img src="assets/backend/img/profile.jpg" alt="user-img"
                                    width="36"
                                    class="img-circle"><span>{{ auth()->user()->username }}</span></span> </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li>
                                    <div class="user-box">
                                        <div class="u-img"><img src="assets/backend/img/profile.jpg" alt="user">
                                        </div>
                                        <div class="u-text">
                                            @auth
...
<script src="assets/backend/js/core/jquery.3.2.1.min.js"></script>
<script src="assets/backend/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js"></script>
<script src="assets/backend/js/core/popper.min.js"></script>
<script src="assets/backend/js/core/bootstrap.min.js"></script>
<script src="assets/backend/js/plugin/chartist/chartist.min.js"></script>
<script src="assets/backend/js/plugin/chartist/plugin/chartist-plugin-tooltip.min.js"></script>
<script src="assets/backend/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>
<script src="assets/backend/js/plugin/bootstrap-toggle/bootstrap-toggle.min.js"></script>
<script src="assets/backend/js/plugin/jquery-mapael/jquery.mapael.min.js"></script>
<script src="assets/backend/js/plugin/jquery-mapael/maps/world_countries.min.js"></script>
...
<script src="assets/backend/js/ready.min.js"></script>
